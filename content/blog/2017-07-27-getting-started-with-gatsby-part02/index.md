---
title: Creating a Blog with Gatsby, Part 02
path: /getting-started-with-gatsby-part02
...
tags:
  ...
  - javascript
image: preview.png
excerpt: Part 02 ~ Gatsby is an incredible static site generator that lets you build a static site that still has all the benefits expected from a modern web application. In this tutorial, we'll create a static blog, and get an in-depth look at Gatsby and its feature-set.
---
